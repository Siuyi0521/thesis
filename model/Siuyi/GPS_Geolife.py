...
group1_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_second_group1_onehot_CTS_Input_SP=9.txt",dtype=np.int)
group2_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_second_group2_onehot_CTS_Input_SP=9.txt",dtype=np.int)
group3_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_second_group3_onehot_CTS_Input_SP=9.txt",dtype=np.int)
group4_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_second_group4_onehot_CTS_Input_SP=9.txt",dtype=np.int)

group1_text = group1_text.reshape(1906,8,148)
group2_text = group2_text.reshape(1680,8,148)
group3_text = group3_text.reshape(1441,8,148)
group4_text = group4_text.reshape(384,8,148)

group1_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_first_group1_onehot_Output_SP=9.txt",dtype=np.int)
group2_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_first_group2_onehot_Output_SP=9.txt",dtype=np.int)
group3_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_first_group3_onehot_Output_SP=9.txt",dtype=np.int)
group4_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/Geolife/_sequenceLength=9/Geolife_first_group4_onehot_Output_SP=9.txt",dtype=np.int)
...
global_train_text = np.concatenate((group1_train_text, group2_train_text,group3_train_text,group4_train_text),axis = 0)
global_train_label = np.concatenate((group1_train_label, group2_train_label,group3_train_label,group4_train_label),axis = 0)
global_test_text = np.concatenate((group1_test_text, group2_test_text,group3_test_text,group4_test_text),axis = 0)
global_test_label = np.concatenate((group1_test_label, group2_test_label,group3_test_label,group4_test_label),axis = 0)
#%%
Global = []
Group = []
Att = []
...
for i in range(0,1):
    ...
    if(i == 4):
        ...
        #變數設置
    group_train_text = group2_train_text
    group_train_label = group2_train_label
    group_test_text = group2_test_text
    group_test_label = group2_test_label

    global_first_inputs = Input(shape = (8,148,))
    ...
    group_first_inputs = Input(shape = (8,148,))
    ...
    global_model.compile(loss = 'categorical_crossentropy',optimizer='adam',metrics=[top_k_acc])
    group_model.compile(loss = 'categorical_crossentropy',optimizer='adam',metrics=[top_k_acc])
    ...
    Tgroup_first_inputs = Input(shape = (8,148,))
