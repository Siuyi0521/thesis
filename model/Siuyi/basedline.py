...
#%%
group1_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/_sequenceLength=9/Geolife_second_group1_onehot_category_Input_SP=9.txt",dtype=np.int)
group2_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/_sequenceLength=9/Geolife_second_group2_onehot_category_Input_SP=9.txt",dtype=np.int)
group3_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/_sequenceLength=9/Geolife_second_group3_onehot_category_Input_SP=9.txt",dtype=np.int)
...
#%%
group1_text = group1_text.reshape(1906,8,118)
group2_text = group2_text.reshape(1680,8,118)
group3_text = group3_text.reshape(1441,8,118)
group4_text = group4_text.reshape(384,8,118)

group1_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/_sequenceLength=9/Geolife_first_group1_onehot_Output_SP=9.txt",dtype=np.int)
group2_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/_sequenceLength=9/Geolife_first_group2_onehot_Output_SP=9.txt",dtype=np.int)
group3_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/_sequenceLength=9/Geolife_first_group3_onehot_Output_SP=9.txt",dtype=np.int)
group4_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/_sequenceLength=9/Geolife_first_group4_onehot_Output_SP=9.txt",dtype=np.int)
...
for i in range(0,5):
    ...
    global_first_inputs = Input(shape = (8,118,))
    ...
    group_first_inputs = Input(shape = (8,118,))
    ...
    Tgroup_first_inputs = Input(shape = (8,118,))
    ...
    softmax = Activation('softmax')(concat)
