...
group1_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group1_onehot_category_Input_SP=9.txt",dtype=np.int)
group2_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group2_onehot_category_Input_SP=9.txt",dtype=np.int)
group3_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group3_onehot_category_Input_SP=9.txt",dtype=np.int)
...
group1_text = group1_text.reshape(6738,8,18)
group2_text = group2_text.reshape(520,8,18)
group3_text = group3_text.reshape(6745,8,18)
#group4_text = group4_text.reshape(384,8,118)

group1_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group1_onehot_Output_SP=9.txt",dtype=np.int)
group2_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group2_onehot_Output_SP=9.txt",dtype=np.int)
group3_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group3_onehot_Output_SP=9.txt",dtype=np.int)
#group4_label = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=3/OSM_group4_onehot_Output_SP=3.txt",dtype=np.int)
...
global_train_text = np.concatenate((group1_train_text, group2_train_text,group3_train_text),axis = 0)
global_train_label = np.concatenate((group1_train_label, group2_train_label,group3_train_label),axis = 0)
global_test_text = np.concatenate((group1_test_text, group2_test_text,group3_test_text),axis = 0)
global_test_label = np.concatenate((group1_test_label, group2_test_label,group3_test_label),axis = 0)
#%%
Global = []
Group = []
Att = []
...
for i in range(0,5):
    ...
    Tgroup_first_inputs = Input(shape = (8,18,))
