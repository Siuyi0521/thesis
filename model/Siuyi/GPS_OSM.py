...
#%%
group1_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group1_onehot_CTS_Input_SP=9.txt",dtype=np.int)
group2_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group2_onehot_CTS_Input_SP=9.txt",dtype=np.int)
group3_text = np.loadtxt("C:/Users/Siuyi/Desktop/Siuyi/Siuyi/OSM/_sequenceLength=9/OSM_group3_onehot_CTS_Input_SP=9.txt",dtype=np.int)
...
#%%
group1_text = group1_text.reshape(6738,8,48)
group2_text = group2_text.reshape(520,8,48)
group3_text = group3_text.reshape(6745,8,48)
